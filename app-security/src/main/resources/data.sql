...
INSERT INTO security_role (id, role_name, description) VALUES (2, 'ROLE_ANALYZER', 'Analyser Employee Representative');

INSERT INTO user_role(user_id, role_id) VALUES
 (1, 1), -- give admin ROLE_ADMIN
 (2, 2),  -- give Jane ROLE_ANALYZER
 (3, 2),  -- give Mark ROLE_ANALYZER
 (4, 1),  -- give Wally ROLE_ADMIN
 (4, 2);  -- give Wally ROLE_ANALYZER
