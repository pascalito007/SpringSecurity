...
import com.elis.pricing.appsecurity.repo.RoleRepository;
import com.elis.pricing.appsecurity.repo.UserRepository;
...
public class UserService {
    ...
    public Optional<User> signup(String username, String password, String firstName, String lastName) {
        ...
        if (!userRepository.findByUsername(username).isPresent()) {
            Optional<Role> role = roleRepository.findByRoleName("ROLE_ANALYZER");
